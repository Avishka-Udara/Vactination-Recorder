...
public class SUCCESSFULLY_EDIT extends JFrame {
	...
	public SUCCESSFULLY_EDIT() {
		...
		JLabel lblNewLabel = new JLabel("EDITED SUCCESSFULLY");
		...
		JButton btnBackToEdit = new JButton("Edit Another");
